...
function generateItems(today) {
  today = today || newDate();
  return [
    { id: 1, title: 'Riverview - Room 2108 - Bed 2', date: randomDate() },
    { id: 2, title: 'Riverview - Room 2201 - Bed 1', date: randomDate(addMinutes(today, -60), addMinutes(today, 60)) },
    { id: 3, title: 'Bayshore - Room 231 - Bed 1', date: randomDate() },
    { id: 4, title: 'Riverview - Room 2201 - Bed 1', date: randomDate() },
  ];
}
