...
Rails.application.configure do
  ...
  config.action_cable.url = 'wss://uhehadev.univago.com:8443'
  config.action_cable.allowed_request_origins = ["https://uhehadev.univago.com"]
  ...
  config.action_mailer.default_url_options = { :host => "uhehadev.univago.com" }
