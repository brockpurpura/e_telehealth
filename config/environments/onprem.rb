...
Rails.application.configure do
  ...
  config.action_cable.allowed_request_origins = ["https://vachiuheapp01.univagohe.net"]
  ...
  # config.action_controller.asset_host = 'http://assets.example.com'
   config.action_mailer.default_url_options = { :host => "vachiuheapp01.univagohe.net" }
